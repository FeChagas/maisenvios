...
<html lang="en" class="light">
    ...
    <body class="main">
            ...
            <div class="content ">
                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <a href="/new-user.php" class="btn btn-primary shadow-md mr-2">Novo usuário</a>
                    </div>
                </div>
                            ...
                            <div class="p-5">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-b-2 dark:border-dark-5 whitespace-nowrap">E-mail</th>
                                        <th class="border-b-2 dark:border-dark-5 whitespace-nowrap">Ativo</th>
                                    </tr>
                                </thead>
                                <tbody id="ready-users">
        ...
        <script src="dist/routes/ready-user.js?<?php echo rand(100,999).'='.rand(100,999);?>"></script>
        <!-- END: JS Assets-->
    </body>
</html>